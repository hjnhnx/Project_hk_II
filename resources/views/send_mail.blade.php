            ...
            <div class="col-lg-12 p-0" style="margin: auto">
                <table cellspacing="0" cellpadding="10" width="90%" style="margin: auto">
                    ...
                    @foreach($order_details as $order_detail)
                        <tr>
                            <td><a href="http://sun-mobile.herokuapp.com/{{\App\Models\Product::find($order_detail->product_option->product_id)->slug}}">{{\App\Models\Product::find($order_detail->product_option->product_id)->name}}</a></td>
